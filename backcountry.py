...
##        try:
        ...
        #商品名
        name = browser.find_element_by_xpath('/html/body/div[2]/div/article/div[2]/section[2]/div[1]/h1').text
        ...
        #値段
        price = browser.find_element_by_xpath('/html/body/div[2]/div/article/div[2]/section[2]/div[2]/span').text
        price = price.replace('$', '')
        ...
        while True:
            try:
                browser.find_element_by_xpath('/html/body/div[2]/div/article/div[2]/section[1]/div[2]/div[3]/div/ul/li[' + str(colornum) + ']/img').click()
                time.sleep(5)
            except:
                break
...
##
            ...
            while True:
                try:
                    img = browser.find_element_by_xpath('/html/body/div[2]/div/article/div[2]/section[1]/div[1]/ul/li[' + str(num) + ']/img')
                    src = img.get_attribute('src')
                    src = src.replace('small','900')
                    print(src)
                    if not src in gazou:
                        gazou.append(src)
