...
wb = openpyxl.load_workbook('C:\\Users\\tomoa\\Workspace\\buyma' + excelName + '.xlsx')
ws = wb.active
...
while True:
    ...
    try:
        ...
        if action == 'new':
            ...
            ###　商品写真　###
            #################
            dir = "C:\\Users\\tomoa\\Workspace\\buyma" + excelName + '\\' + str(folderNum)
            files = os.listdir(dir) #ファイルのリストを取得

            for file in files:
                picture = "C:\\Users\\tomoa\\Workspace\\buyma" + excelName + '\\' + str(folderNum) + '\\' + file
