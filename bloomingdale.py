...
##        try:
        ...
        #商品名
        name = browser.find_element_by_xpath('/html/body/div[3]/div/div[2]/div[1]/div[2]/div[1]/div/div[1]/div/h1').text
        ...
        ws['B' + str(int(yoko) + 1)].value = brandName(name) + japanese(name, yoko, ws)
        print(name)

        #値段
        price = browser.find_element_by_xpath('/html/body/div[3]/div/div[2]/div[1]/div[2]/div[1]/div/div[3]/div/div/span').text
        price = price.replace('$', '')
        ...
        while True:
            try:
                browser.find_element_by_xpath('/html/body/div[3]/div/div[2]/div[1]/div[2]/div[2]/div/div[1]/div/div/div[2]/div/div/div[' + str(colornum) + ']/label/img').click()
                time.sleep(5)
            except:
                break
            ...
            color = browser.find_element_by_xpath('/html/body/div[3]/div/div[2]/div[1]/div[2]/div[2]/div/div[1]/div/div/div[1]/span[2]').text
...
##                print(out)
##
##                size = browser.find_element_by_xpath('//*[@id="size-dropdown-' + out + '"]').text
##                print(size)
##
##            sizenum = 2
##            try:
##                while True:
##                    size = browser.find_element_by_xpath('/html/body/div[2]/div/div[2]/div[1]/div[2]/div[2]/div/div[2]/div/div/div[1]/div[1]/div/div/select/option[' + str(sizenum) + ']').text
##                    if not 'not available' in size:
...
##                try:
##                    while True:
##                        size = browser.find_element_by_xpath('/html/body/div[2]/div/div[2]/div[1]/div[2]/div[2]/div/div[2]/div/div/div[1]/div[1]/div/div/select/option[' + str(num) + ']').text
##                        print(size)
##                        if not 'not available' in size:
##                            sizeList.append(SIZE)
##
...
##                    print(sizeList)
            ...
            try:
                while True:
                    if num == 5:
                        break
                    img = browser.find_element_by_xpath('/html/body/div[3]/div/div[2]/div[1]/div[1]/div/div/div/div/div/div[1]/div/article/div/ul/li[' + str(num) + ']/label/img')
